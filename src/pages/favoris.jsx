                                                        ...
                                                        <CarouselContent>
                                                            {
                                                                a.detailAnnonce.images.map((url, i) => {
                                                                    return(
                                                                        <CarouselItem key={i}>
                                                                            <div className="lg:h-[350px]" style={{backgroundSize: 'cover',backgroundPosition: 'center' ,backgroundRepeat: 'no-repeat' ,backgroundImage: "url('https://rest-production-e2d3.up.railway.app/images/"+ url +"')"}}/>
                                                                        </CarouselItem>
                                                                    )
                                                                })
                                                            }
